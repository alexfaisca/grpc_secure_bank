package pt.tecnico.sirs.userclient.tools;

import pt.tecnico.sirs.cryptology.Base;
import pt.tecnico.sirs.cryptology.Security;
...
public class SecureDocument {
    ...
    public SecureDocument(String ivPath, String secretKeyPath, String publicKeyPath, String privateKeyPath) throws Exception {
